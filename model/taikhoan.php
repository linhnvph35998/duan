<?php
    ...
    function update_taikhoan($id,$user,$email,$address,$pass,$tel){
       
        $sql="UPDATE taikhoan set id='".$id."' ,pass='".$pass."' ,tel='".$tel."' ,user='".$user."',email='".$email."',address='".$address."' where id=".$id;
        pdo_execute($sql);
